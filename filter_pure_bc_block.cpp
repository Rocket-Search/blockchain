...
{
	//cout<<"filter_pure_bc_block.cpp"<<endl;
	//cout<<"\e[1m"<<"filter_pure_bc_block.cpp"<<"\e[0m"<<endl;
	...
	wo_ist_set_block = pure_bc_block.find("set block to bc_server###");
	//cout<<"wo_ist_set_block#"<<wo_ist_set_block<<endl;
	//pure_bc_block = pure_bc_block.substr(wo_ist_set_block + 26 ,pure_bc_block.length());		// "set block to bc_server### " abschneiden 14 zeichen
	if (wo_ist_set_block != -1){pure_bc_block = pure_bc_block.substr(wo_ist_set_block + 26 ,pure_bc_block.length());}else{cout<<"PROBLEM in filter_pure_bc_block.cpp pure_bc_block"<<endl;}
	//cout<<"pure_bc_block#"<<pure_bc_block<<endl;
	...
	if(wo_ist_et_und_drei_gatter != -1){pure_bc_block = pure_bc_block.substr(0,wo_ist_et_und_drei_gatter);}else{cout<<"PROBLEM in filter_pure_bc_block.cpp pure_bc_block"<<endl;}
